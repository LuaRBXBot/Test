...
function oyom.CreateLib(oyoName, themeList)
	...
	local selectedTab 
	oyoName = oyoName or "Library" table.insert(oyom, oyoName) for i,v in pairs(game.CoreGui:GetChildren()) do if v:IsA("ScreenGui") and v.Name == kavName then v:Destroy() end end
	...
	oyom:DraggingEnabled(MainHeader, Main)
	...
	UserInfo.Position = UDim2.new(0, 0, 0.871972322, 0)
	UserInfo.Size = UDim2.new(0, 148, 0, 28)
	...
	local playesr = game:GetService("Players").LocalPlayer
	UserImageLabel.Parent = UserInfo
	UserImageLabel.BackgroundColor3 = Color3.new(1, 1, 1)
	UserImageLabel.Position = UDim2.new(0.0608108081, 0, -0.110807143, 0)
	UserImageLabel.Size = UDim2.new(0, 32, 0, 31)
	UserImageLabel.Image = "http://www.roblox.com/Thumbs/Avatar.ashx?x=150&y=150&Format=Png&username="..playesr.Name
	...
	function oyom:ChangeColor(prope,color)
